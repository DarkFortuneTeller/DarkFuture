...
public class DFNeedsMenuBar extends inkCanvas {
    ...
    public final func SetDefaultValues() -> Void {
        ...
        this.m_changeBar.SetSize(new Vector2(0.00, this.m_height));
    }
    ...
    private final func CreateBar() -> ref<inkCanvas> {
        ...
        canvas.SetSize(new Vector2(this.m_setupData.canvasWidth, 60.0));
        canvas.SetHAlign(inkEHorizontalAlign.Center);
        canvas.SetMargin(new inkMargin(0.0, 0.0, this.m_setupData.canvasRightMargin, 0.0));
        ...
        icon.SetMargin(new inkMargin(20.0, 10.0, 20.0, 0.0));
        icon.SetSize(new Vector2(30.0, 30.0));
        ...
        vertPanel.SetMargin(new inkMargin(20.0, 0.0, 0.0, 0.0));
        vertPanel.SetAnchor(inkEAnchor.TopLeft);
        vertPanel.SetVAlign(inkEVerticalAlign.Center);
        vertPanel.SetSize(new Vector2(100.0, 32.0));
        ...
        empty.SetSize(new Vector2(0.0, 8.0));
        ...
        fullBar.SetShear(new Vector2(0.5, 0.0));
        fullBar.SetTranslation(8.0, 0.0);
        fullBar.SetSize(new Vector2((this.m_setupData.canvasWidth * 0.875) - 2.0, this.m_barContentHeight));
        ...
        changeBar.SetShear(new Vector2(0.5, 0.0));
        changeBar.SetTranslation(8.0, 0.0);
        changeBar.SetSize(new Vector2(0.0, this.m_barContentHeight));
    ...
    public final func SetUpdatedValue(newValue: Float, max: Float) -> Void {
        ...
        if this.m_previousValue < this.m_currentValue && this.m_currentValue - this.m_previousValue >= 0.01 {
            ...
            this.m_changeBar.SetSize(new Vector2(((this.m_width * this.m_currentValue) - (this.m_width * this.m_previousValue)), this.m_barContentHeight));
            ...
            this.m_fullBar.SetSize(new Vector2((this.m_width * this.m_currentValue) - 2.0, this.m_barContentHeight));
            this.m_changeBar.SetSize(new Vector2(((this.m_width * this.m_previousValue) - (this.m_width * this.m_currentValue)), this.m_barContentHeight));
            fullBarSize = this.m_fullBar.GetSize();
    ...
    public final func SetProgressEmpty(newValue: Float) {
        this.m_emptyBar.SetSize(new Vector2(this.m_width * newValue, this.m_barContentHeight));
        this.m_emptyBar.SetMargin(new inkMargin(0.0, 0.0, 3.0, 0.0));
    }
